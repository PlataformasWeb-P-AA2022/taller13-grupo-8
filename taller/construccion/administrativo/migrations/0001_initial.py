# Generated by Django 4.0.5 on 2022-07-12 19:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edificio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='los_departamentos', to='administrativo.edificio')),
            ],
        ),
    ]
